...
use rustc::middle::{privacy::{self, AccessLevels}, reachable::ReachableSet};
use rustc::session::config;
use rustc::util::nodemap::{NodeSet, FxHashSet};
...
// true for functions.
fn item_might_be_inlined<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>,
                         item: &hir::Item,
...
pub(crate) fn reachable_set_from_levels<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>, access_levels: &AccessLevels) -> ReachableSet {
